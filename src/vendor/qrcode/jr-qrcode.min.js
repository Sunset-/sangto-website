        ...
        a.fn.qrcode = function(b) {
            ...
            var c = function() {
                    ...
                    var d = c.getContext("2d"),
                        e = (b.width - 2 * b.padding) / a.getModuleCount(),
                        f = (b.height - 2 * b.padding) / a.getModuleCount();
                    d.fillStyle = "#ffffff", d.fillRect(0, 0, c.width, c.height);
                    for (var g = 0; g < a.getModuleCount(); g++)
                        for (var h = 0; h < a.getModuleCount(); h++) {
                            ...
                            d.fillRect(Math.round(h * e) + b.padding, Math.round(g * f) + b.padding, i, j)
                        }
                    return c
                },
                d = function() {
...
window.jrQrcode = function() {
    ...
    var b = function(b, c) {
        "object" != typeof c && (c = {}), c.text = a(b);
        var d = "jrqrcode-div-id-" + (new Date).getTime();
        $(document.body).append('<div id="' + d + '" style="display:none;"></div>');
        var e = $("#" + d);
        e.qrcode(c);
        var f = e.children("canvas"),
            g = "";
        return f.length >= 0 && (g = f[0].toDataURL()), e.remove(), g
    };
    return {
        getQrBase64: b
    }
